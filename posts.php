...
if (isset($_GET['category'])) {
  $category_id = (int)$_GET['category']; // ✅ امن‌سازی
    ...
    <div class="hero-container">
      <div class="hero-content">
        ...
        <p>
          ...
          با جستجو در سایت،<br> به انواع کتاب‌ها دسترسی پیدا کنید.
        </p>
      </div>
      <div class="hero-book">
      ...
      <div class="container-fluid">
        ...
        <div class="posts-grid">
          ...
          if ($posts->rowCount() > 0) {
              ...
              <article class="post-card">
                ...
                <div class="post-body">
                  ...
                  <p class="post-excerpt">
                    <?php echo mb_substr(strip_tags($post['body']), 0, 500, 'UTF-8') . "..."; ?>
                  </p>
                  <footer class="post-footer">
                    <a href="single.php?post=<?php echo (int)$post['id']; ?>" class="btn-view-post">مشاهده</a>
            ...
            echo "<div class='no-posts-alert'>مقاله‌ای یافت نشد!</div>";
          }
          ?>
        </div>
      </div>
